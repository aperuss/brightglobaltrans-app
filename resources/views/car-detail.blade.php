<x-app>
    <div class="mx-4 sm:mx-6 lg:mx-16 mt-6 md:mt-12 lg:mt-16">
        <div class="grid grid-cols-1 md:grid-cols-4 md:grid-rows-6 gap-6">
            ...
            <div class="md:col-span-2 md:row-span-2  overflow-hidden">
                <div class="shadow-lg ">
                    ...
                    <div class="bg-[#b6b6b6] flex justify-center items-center py-6 md:py-8">
                ...
                <div class="shadow-lg">
                    ...
                    <div class="bg-[#b6b6b6]">
                        <div class="flex flex-col md:flex-row items-center justify-around font-semibold py-6 text-lg md:text-xl">
                            <span>Rp 1.500.000/Hari</span>
                            <span>Rp 7.500.000/Minggu</span>
                        </div>
            ...
            <div class="md:col-span-2 md:row-span-4 overflow-hidden">
                <div class="shadow-lg rounded-lg">
                    ...
                    <div class="bg-[#b6b6b6] text-justify p-6 md:p-8 leading-relaxed">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestiae earum minima animi aut expedita id dignissimos nam sapiente accusantium eligendi! Possimus nam amet dicta itaque incidunt ullam odit sed sit?
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla, quod rem debitis doloremque, delectus, praesentium sunt ab officiis sapiente reiciendis error corporis eos facilis modi natus. Quibusdam eaque illo commodi.
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus numquam recusandae eveniet nobis aperiam reprehenderit accusantium impedit vitae, distinctio commodi voluptate magnam harum excepturi dolor quae sequi, aut ea sit.
                        Lorem ipsum dolor sit, amet consectetur adipisicing elit. A aliquam itaque ad numquam, nihil, maxime officia excepturi assumenda reprehenderit debitis facilis vitae asperiores incidunt! Doloremque suscipit hic placeat. Quasi, nam!
                    </div>
                </div>
            </div>
        </div>
