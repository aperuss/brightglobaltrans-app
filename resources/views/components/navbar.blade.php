<div>
    <div class="font-[Poppins]">
        <!-- Sticky Header -->
        <header class="bg-[#046d37] sticky top-0 z-50 shadow-md md:px-4 px-2">
            <nav class="flex justify-between items-center w-full">
                ...
                <!-- Navigation Links -->
                <div class="nav-links md:static absolute bg-[#046d37] md:min-h-fit min-h-[60vh] left-0 top-0 md:w-auto w-full flex items-center px-5 md:translate-x-0 transform -translate-x-full duration-300">
                ...
                <div class="flex items-center gap-6">
                    <button class="bg-baseBackground text-black px-5 py-2 rounded-full">Kontak</button>
